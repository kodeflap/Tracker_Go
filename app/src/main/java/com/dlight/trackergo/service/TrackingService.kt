package com.dlight.trackergo.service
...
import com.dlight.trackergo.util.Constants.LOCATION_UPDATE_INTERVAL
import com.dlight.trackergo.util.Constants.NOTIFICATION_CHANNEL_ID
import com.dlight.trackergo.util.Constants.NOTIFICATION_CHANNEL_NAME
import com.dlight.trackergo.util.Constants.NOTIFICATION_ID
import com.dlight.trackergo.util.Constants.TIMER_UPDATE_INTERVAL
    ...
    private fun startTimer() {
        ...
        CoroutineScope(Dispatchers.Main).launch {
            while(isTracking.value!!) {
                //time difference between now and timestamp
